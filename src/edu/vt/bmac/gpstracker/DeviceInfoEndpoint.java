...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "vt.edu", ownerName = "vt.edu", packagePath = "bmac.gpstracker"))
public class DeviceInfoEndpoint
{
        ...
        @Nullable @Named("limit") Integer limit)
    {
        ...
        try
        {
            ...
            Query query =
                mgr.createQuery("select from DeviceInfo as DeviceInfo");
    ...
    private boolean containsDeviceInfo(DeviceInfo deviceinfo)
    {
        ...
        {
            DeviceInfo item =
                mgr.find(DeviceInfo.class, deviceinfo.getDeviceRegistrationID());
            if (item == null)
            {
                contains = false;
            }
